...
const Index = () => {
    ...
    return (
        <div>
            <div className=' '>
                <h1 className='text-2xl font-bold text-dark-800 mb-4'>Daftar Artikel</h1>
                <div>
            ...
            <div className='mt-4'>
                ...
                <div className=' space-y-4 sm:space-y-0 flex sm:flex-row mb-4 flex-col mt-4'>
                    <Dropdown
                        align="left"
                        width="48"
                        trigger={
            ...
            <div className='grid lg:grid-cols-2 gap-6 my-8'>
                {data?.data.map((item, index) => (
                    <ArticleItem forAdmin mutate={mutate} data={item} key={index} />
                ))}
            </div>
        </div>
    )
